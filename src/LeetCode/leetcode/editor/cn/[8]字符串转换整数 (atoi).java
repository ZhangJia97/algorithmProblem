    ...
    class Solution {
        public int myAtoi(String s) {
            ...
            for (; l < chars.length; l++) {
                final char c = chars[l];
                if (c - '0' > 9 || c - '0' < 0) {
                    break;
                }
                if (!"".equals(stringBuilder.toString()) && !"-".equals(stringBuilder.toString())) {
                    final Integer over = over(Integer.parseInt(stringBuilder.toString()), c - '0');
                    if (over != 0) {
                        return over;
                    }
                }
        ...
        private Integer over(Integer ans, Integer pop) {
